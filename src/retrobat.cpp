...
bool RetroBat::skipExisting(QList<GameEntry> &gameEntries,
...
void RetroBat::assembleList(QString &finalOutput,
...
bool RetroBat::canSkip() { return true; }

QString RetroBat::getGameListFileName() { return QString("gamelist.xml"); }

QString RetroBat::getInputFolder() {
    return QString(QDir::homePath() + "/RetroPie/roms/" + config->platform);
}

QString RetroBat::getGameListFolder() { return config->inputFolder; }

QString RetroBat::getCoversFolder() { return config->mediaFolder + "/covers"; }

QString RetroBat::getScreenshotsFolder() {
    return config->mediaFolder + "/screenshots";
}

QString RetroBat::getWheelsFolder() { return config->mediaFolder + "/wheels"; }
...
QString RetroBat::getVideosFolder() { return config->mediaFolder + "/videos"; }
